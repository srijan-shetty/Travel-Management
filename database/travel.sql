...
--
-- Host: localhost
-- Generation Time: Nov 13, 2017 at 04:38 PM
...
(6, 'bhavya', '9591481372', 'kshubhamm@mail.com', 'ddddfalskfnasldfnasdkFJmDx,falKDFxncasdlkZXfalskDfxalksdFXnlksdXFlksdFlksdnkls.dFlnkadsZx');
...
(13, 25, 'bhavya', 'Male', '9591481372', 'kshubhamm@mail.com', 5, 2, 2, 'need travel details', 'Pending'),
(14, 2, 'Srijan', 'Male', '9591481372', 'kshubhamm@mail.com', 5, 2, 2, 'i want a travel trip', 'Pending'),
(16, 27, 'shubham', 'Male', '9591481342', 'abc@cde.com', 7, 2, 2, 'afblsdk', 'Pending'),
(17, 6, 'Bhavyaaaaa', 'Male', '9678866668', 'abc@cse.com', 5, 2, 2, 'try trigger', 'Pending'),
(18, 6, 'manish', 'Male', '9591481372', 'bhav@cse', 7, 2, 2, 'trav detail', 'Pending'),
(19, 27, 'bhavyaaa', 'Male', '9591481372', 'kshubhamm@mail.com', 4, 2, 2, 'i want some detail', 'Pending');

--
-- Triggers `enquiry`
--
DELIMITER $$
CREATE TRIGGER `log` AFTER INSERT ON `enquiry` FOR EACH ROW INSERT INTO tri_database select Name,Message from enquiry
$$
DELIMITER ;
...
INSERT INTO `Signup` (`id`, `name`, `email`, `age`, `password`, `confirm`) VALUES
(1, 'Bhavya', 'kshubhamm@gmail.com', 44, 'qwerty', ''),
(2, 'MANISH', 'ABC@DCE.COM', 44, 'maish', ''),
(3, 'abc', 'def@gmail.com', 66, 'qwerty', ''),
(4, 'abijit', 'abijit@abx', 25, 'abcxx', ''),
(5, 'name', 'name@cse', 22, '4b93bd3b54a94a33a70ec6b2bfe67f14', ''),
(6, 'namm', 'namm@cse', 21, 'bd17232851df17523fe0bd79c7118b65', ''),
(7, 'abcdef', 'abc1@ac', 34, 'f7ae102894c2dc0a4396c1ae12a5f7f3', ''),
(8, 'fdsvfs', 'abc@ac', 55, '35b225cff53355b39a76990cda58ec8a', ''),
(9, 'bob', 'bob@as', 21, 'eed177c1c19d4b48b7088eccb7412699', ''),
(10, 'sinchana', 'sinch.ana@gmail.com', 21, 'de8fe7ca08f359b6fb4a54441f6dd20b', ''),
(11, 'anup', 'anup@cmrit', 22, '0b6279a218b34a291fc281dcb34c2cc4', ''),
(12, 'MANISH', 'man@cse', 22, '21de6149369ae7857d2c1e75ad3b6923', ''),
(13, 'suyash', 'susg@gmai', 11, 'cfbbf64d1e58ad521f4e38c8ce76938a', ''),
(14, 'legen', 'lez@cse', 22, '7bf45004e9dde911eaa421794c109a37', ''),
(15, 'venu', 'venu@cse', 21, 'e9ee9afeaa893252f1350fa349a2bf3a', ''),
(16, 'utk', 'utk@cse', 21, '8631f2ce52e3693ac2205831d95858d2', ''),
(17, 'mota', 'mota@cse', 21, '3182c34add95b25b120d85f1d13a9d2d', ''),
(18, 'keshava', 'kas@gmai', 21, '3d5247ce7487299fb5acfaf4d30b1565', ''),
(19, 'myname', 'myname@cse', 21, 'ce841d903d043b3db3bc3c4cf6bb3ba6', ''),
(20, 'rob', 'bob@cse', 21, '63c1c9428c7326ade72d6822dd8f3131', ''),
(21, 'rob1', 'abcd@cse', 22, '0cfdfe410ffbd5bc70663ace44965b02', '');
...
--
-- Table structure for table `train-form`
--

CREATE TABLE `train-form` (
  `pass_name` varchar(20) NOT NULL,
  `age` int(20) NOT NULL,
  `gender` varchar(20) NOT NULL,
  `birth` varchar(20) NOT NULL,
  `sen-citizen` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `tri_database`
--

CREATE TABLE `tri_database` (
  `Name` varchar(50) NOT NULL,
  `message` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tri_database`
--

INSERT INTO `tri_database` (`Name`, `message`) VALUES
('bhavya', 'need travel details'),
('Srijan', 'i want a travel trip'),
('Bhavya1', 'FUCK SHIT'),
('shubham', 'afblsdk'),
('Bhavyaaaaa', 'try trigger'),
('bhavya', 'need travel details'),
('Srijan', 'i want a travel trip'),
('Bhavya1', 'FUCK SHIT'),
('shubham', 'afblsdk'),
